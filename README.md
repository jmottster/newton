...
### Version 0.2.3 Alpha Prototype 3D
...
1. Download Ubuntu 24.04 executable here:
   1. [Ubuntu Release 0.2.3](https://github.com/jmottster/newton/releases/download/Release%2Fv0.2.3/newton3D.bin)
2. Download Windows 10 executable here:
   1. [Windows Release 0.2.3](https://github.com/jmottster/newton/releases/download/Release%2Fv0.2.3/newton3D.exe)
...
A PDF version of the following quick reference for controls can be downloaded [here](https://github.com/jmottster/newton/releases/download/Release%2Fv0.2.3/controls_quick_reference.pdf).
