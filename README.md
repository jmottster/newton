...
### Version 0.1.5 Alpha Prototype 3D
...
Alpha release 0.1.5! Now with time rewind! Reverse time in 90 day increments all the way to the beginning of the simulation session. Use the left and right arrow keys to select how far back to go, then press the "M" key to make it so!
...
1. Download Ubuntu 24.04 executable here:
   1. [Ubuntu Release 0.1.5](https://github.com/jmottster/newton/releases/download/Release%2Fv0.1.5/newton3D.bin)
2. Download Windows 10 executable here:
   1. [Windows Release 0.1.5](https://github.com/jmottster/newton/releases/download/Release%2Fv0.1.5/newton3D.exe)
...
A PDF version of the following quick reference for controls can be downloaded [here](https://github.com/jmottster/newton/releases/download/Release%2Fv0.1.5/controls_quick_reference.pdf).
